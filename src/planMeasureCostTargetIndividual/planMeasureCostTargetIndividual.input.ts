...
import { PlanMeasureCostTargetIndividual } from './planMeasureCostTargetIndividual.entity';

@InputType()
export class PlanMeasureCostTargetIndividualInput {
  @Field({ nullable: true })
  id?: number;
...
export const generateCreatePlanMeasureCostTargetIndividualInputFromEntity = (
